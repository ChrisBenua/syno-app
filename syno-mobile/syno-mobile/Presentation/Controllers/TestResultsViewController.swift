...
class TestResultsViewController: UIViewController {
    ...
    lazy var contentView: UIView = {
        ...
        self.tableView.anchor(top: self.headerView.bottomAnchor, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 10, paddingLeft: 20, paddingBottom: 45, paddingRight: 20, width: 0, height: 0)
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Закончить", style: .done, target: self, action: #selector(goBackToTestAndLearnController))
...
extension TestResultsViewController: UIScrollViewDelegate {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        if scrollView.contentOffset.y + scrollView.frame.size.height > scrollView.contentSize.height - 20 {
            scrollView.contentOffset.y = scrollView.contentSize.height - 20 - scrollView.frame.size.height
        }
    }
}
